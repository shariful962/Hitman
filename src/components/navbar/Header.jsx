...
//                 <div>
//                   <img src={Icons.profile1} alt="profile" className="w-12 h-12 rounded-full" />
//                 </div>
//               </button>
//             </div>
            ...
            <div className="flex items-center justify-between px-4 lg:px-[120px] py-4">
              ...
              <div className="hidden lg:flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-1.5 bg-Primary text-white rounded-[8px] cursor-pointer"
                >
                  + Create Post 
                </button>
                <button className="cursor-pointer" onClick={()=>navigate('/profile')}>
                  <div>
                    <img src={Icons.profile1} alt="profile" className="w-10 h-10 rounded-full" />
                  </div>
                </button>
              </div>
