...
//   // State to track which trips are liked
...
// import PostCard from "../expedition/PostCard";
// import { useNavigate, Outlet } from "react-router-dom";
// import CreatePostModal1 from "../../components/navbar/CreatePostModal1";
...
//   const [modalContent, setModalContent] = useState(null); // pre-fill data for modal
...
//       title: trip.title,
//       image: trip.image,
//       caption: `Check out this trip: ${trip.title}`, // default caption
//     });
//     setModalOpen(true);
//   };
...
//             prefillData={modalContent} // pass the selected trip content
//           />
//         )}
...
const Hitlists = () => {
  ...
  const [likedTrips, setLikedTrips] = useState([]);
  const [modalOpen, setModalOpen] = useState(false);
  const [modalTrip, setModalTrip] = useState(null); // store the trip to show in modal
    ...
    <div className="containerBox px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {modalOpen && modalTrip && (
          <CreatePostModal1
            onClose={() => setModalOpen(false)}
            trip={modalTrip} // full trip object
          />
        )}
