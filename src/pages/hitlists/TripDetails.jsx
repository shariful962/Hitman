      ...
      <div className=" mt-8 mb-6">
        ...
        <div className="flex gap-3">
          <div className="py-2 rounded-lg flex items-center gap-2">
            <img src={Icons.profile1} alt="" className="h-12 w-12 rounded-full" />
            <button className="cursor-pointer">
              <img src={Icons.shareButton} alt=""  className="w-[150px]"/>
            </button>
            <button className="bg-dark2 px-4 py-[6px] rounded text-sm cursor-pointer">Add to calender</button>
