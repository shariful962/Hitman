    ...
    <div>
      ...
      <div className="bg-[#111] text-white rounded-2xl p-4  w-full max-w-[319px]">
        ...
        <ul className="text-xs space-y-1 mb-4">
          <li className="flex gap-2"><FiCheck size={22} className="text-Primary" />  Day 1: Beach & Chill Laboni Beach, Sugandha Sunset</li>
          <li className="flex gap-2"> <FiCheck size={22} className="text-Primary" /> Day 2: Nature & Adventure Himchari, Inani, Marine Drive</li>
          <li className="flex gap-2"> <FiCheck size={22} className="text-Primary" /> Day 3: Local & Leisure Fish Market, Burmese Market</li>
        </ul>
      ...
      <div className="spacy-y-2">
        ...
        <button
          //   onClick={onClick}
          className="mt-3 mb-4 cursor-pointer flex items-center gap-2 bg-black text-white px-4 py-2 rounded-md "
        >
          <FiRefreshCw />
          Regenerate Plan
        </button>
